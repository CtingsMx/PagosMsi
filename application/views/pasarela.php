...
var error_callbak = function(response) {
    ...
    {
        $("#errorOpenpay").show().html('Favor de completar tú información, recuerda que la tarjeta debe ser de 16 dígitos y sin espacios, además debes capturar la fecha de expiración y tu código de seguridad.');
    }
            ...
            <form action="./datosPagos" method="POST" id="payment-form">
                ...
                <div class="pymnt-itm card active">
                    ...
                    <div class="pymnt-cntnt">
                        ...
                        <div class="alert alert-danger" role="alert" style="<?php echo (!isset($_GET['error'])) ? "display:none" : "" ?>" id="errorOpenpay">
